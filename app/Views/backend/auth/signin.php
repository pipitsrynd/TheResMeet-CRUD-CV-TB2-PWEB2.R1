                ...
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <?php endif;?>
                            <form method="POST" action="/internal/signin" class="needs-validation" novalidate="">
                                <?= csrf_field(); ?>
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input id="email" type="email" class="form-control <?= $validation->hasError('email') ? 'is-invalid' : '' ?>" name="email" tabindex="1" autofocus>
                    ...
                    <div class="simple-footer">
                        Copyright &copy; Kelompok 3 2022
                    </div>
                </div>
            </div>
        </div>
